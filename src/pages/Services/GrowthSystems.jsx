        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-[#a2adc4]/5 flex flex-col">
              ...
              <Link className="text-[#4647d3] font-bold inline-flex items-center gap-2 group/link w-fit">
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-[#a2adc4]/5 flex flex-col">
              ...
              <Link className="text-[#6a37d4] font-bold inline-flex items-center gap-2 group/link w-fit">
                Learn more <span className="material-symbols-outlined text-sm group-hover/link:translate-x-1 transition-transform" style={iconStyle}>arrow_forward</span>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <Link to="/work/growth-systems" className="block group cursor-pointer">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#242f41] group-hover:text-[#4647d3] transition-colors">Enterprise SaaS Launch</h3>
            ...
            <Link to="/work/growth-systems" className="block group cursor-pointer">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#242f41] group-hover:text-[#4647d3] transition-colors">D2C Global Expansion</h3>
              <p className="text-[#515c70] font-body leading-relaxed">
