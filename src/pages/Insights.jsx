      ...
      <main className="relative pt-20">
        ...
        <section className="max-w-7xl mx-auto px-6 pb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            {/* Large Featured Card */}
            <div className="md:col-span-8 bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-indigo-100/40 transition-shadow group cursor-pointer">
