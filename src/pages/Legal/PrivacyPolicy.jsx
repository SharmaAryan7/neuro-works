      ...
      <section className="max-w-7xl mx-auto px-6 mb-32">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-[#040e1f] p-12 md:p-24 text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[#cdddfe]/70 text-lg mb-12 max-w-xl mx-auto">Our legal and data privacy teams are here to help you understand how we handle your digital footprints.</p>
