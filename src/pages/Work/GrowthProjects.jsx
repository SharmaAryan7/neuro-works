        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="group bg-surface-container-lowest rounded-[20px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-outline-variant/10 flex flex-col">
              ...
              <div className="p-8 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-4 gap-4">
                  <h3 className="text-2xl font-bold text-on-surface font-headline">Precision Ad-Tech Scale</h3>
                  <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-semibold shrink-0">+45% Conversions</span>
                </div>
                ...
                <Link to="/work/growth-systems" className="flex items-center text-primary font-bold group/link inline-flex w-fit">
            ...
            <div className="group bg-surface-container-lowest rounded-[20px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-outline-variant/10 flex flex-col">
              ...
              <div className="p-8 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-4 gap-4">
                  <h3 className="text-2xl font-bold text-on-surface font-headline">B2B Omni-Channel Hub</h3>
                  <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-semibold shrink-0">3x Lead Flow</span>
                </div>
                <p className="text-on-surface-variant leading-relaxed mb-6 flex-grow">
            ...
            <div className="group bg-surface-container-lowest rounded-[20px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-outline-variant/10 flex flex-col">
              ...
              <div className="p-8 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-4 gap-4">
                  <h3 className="text-2xl font-bold text-on-surface font-headline">Retention Engine 2.0</h3>
                  <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-semibold shrink-0">-22% Churn Rate</span>
                </div>
                <p className="text-on-surface-variant leading-relaxed mb-6 flex-grow">
            ...
            <div className="group bg-surface-container-lowest rounded-[20px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-outline-variant/10 flex flex-col">
              <div className="aspect-video relative overflow-hidden">
                <img alt="E-commerce Scale" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC1osttCFwoJR9XOpi5fwgKUdoPrZWoc_wIzrkutMoT4t_F1YEhprcvquTjjBR6jlknIdl4UK65I-O-2miQMyvjp0OHu_MTXRwiXenDngiHg6_wn0txHiPFOaWQEpx3b_QhQeQtrLkf9TCc3REM5D0ANTHNgugBCUlm7cnHAbXcJ2RPbbRnr7DSkhOMETUSIvHVGl5gaXF9cF_q6HJXr5wKgMplHj18KfBdWr_re49axq6fYyBs1HRZpCHJ40a1F-_8f6HttsELesSz" />
              </div>
              <div className="p-8 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-4 gap-4">
                  <h3 className="text-2xl font-bold text-on-surface font-headline">Direct-to-Consumer Sprint</h3>
                  <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-semibold shrink-0">+112% Revenue</span>
                </div>
                <p className="text-on-surface-variant leading-relaxed mb-6 flex-grow">
      ...
      <section className="bg-surface-container-low px-8 py-24 border-y border-outline-variant/10">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <Link to="/work/growth-systems" className="flex items-center text-primary font-bold text-lg hover:underline decoration-2 underline-offset-4 shrink-0">
            ...
            <Link to="/work/growth-systems" className="block bg-surface-container-lowest rounded-[24px] p-2 overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-bold tracking-widest uppercase text-on-surface-variant font-label">Enterprise Scale</span>
                </div>
                <h4 className="text-3xl font-bold text-on-surface mb-4 font-headline">The $100M Expansion Project</h4>
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-surface text-on-surface-variant text-xs font-semibold rounded-lg">FinTech</span>
                  <span className="px-4 py-2 bg-surface text-on-surface-variant text-xs font-semibold rounded-lg">Scale</span>
                  <span className="px-4 py-2 bg-surface text-on-surface-variant text-xs font-semibold rounded-lg">Global</span>
                  <span className="px-4 py-2 bg-surface text-on-surface-variant text-xs font-semibold rounded-lg">Strategy</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/work/growth-systems" className="block bg-surface-container-lowest rounded-[24px] p-2 overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-bold tracking-widest uppercase text-on-surface-variant font-label">Market Disruption</span>
                </div>
                <h4 className="text-3xl font-bold text-on-surface mb-4 font-headline">Neuro-Marketing Revolution</h4>
                <p className="text-on-surface-variant mb-8 leading-relaxed">
                  Leveraging biometric feedback to craft messaging that resonates on a subconscious level, achieving 80% higher engagement.
                </p>
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-surface text-on-surface-variant text-xs font-semibold rounded-lg">Neuro-analytics</span>
                  <span className="px-4 py-2 bg-surface text-on-surface-variant text-xs font-semibold rounded-lg">Biometrics</span>
                  <span className="px-4 py-2 bg-surface text-on-surface-variant text-xs font-semibold rounded-lg">Engagement</span>
                  <span className="px-4 py-2 bg-surface text-on-surface-variant text-xs font-semibold rounded-lg">Optimization</span>
                </div>
              </div>
            </Link>
          </div>
